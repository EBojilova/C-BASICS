...
class FallingRocks
{
    ...
    static void Main()
    {
        ...
        dwarf.color = ConsoleColor.DarkGreen;
        dwarf.symbol = "(0)";
        ...
        while (true)
        {
            ...
            bool collision = false;
            {
                ...
                for (int i = 1; i <= numberOfRocksOnLine; i++)
                {
                    ...
                    newRock.color = (ConsoleColor)randomGenerator.Next((int)ConsoleColor.Green, (int)ConsoleColor.Red + 1);
                    newRock.y = 0;
            ...
            PrintGameString(playfieldWidth + 2, 2, "FALLING ROCKS", ConsoleColor.DarkRed);
            PrintGameString(playfieldWidth + 2, 6, "lives: " + livesCount + " @", ConsoleColor.DarkGreen);
            PrintGameString(playfieldWidth + 2, 7, "lines: " + lines, ConsoleColor.DarkGreen);
            PrintGameString(playfieldWidth + 2, 8, "speed: " + (int)speed, ConsoleColor.DarkGreen);
